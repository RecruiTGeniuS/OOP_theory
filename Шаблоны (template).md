...
### **Шаблон Класса**
---
Шаблон класса будет использоваться гораздо чаще, чем шаблон функции. И в большинстве случаев это будет шаблон для абстрактного типа, поведение которогоя является универсальным.

Перейдём сразу к примеру и зададим класс:
```c++
class Matrix
{
private:
...
```
 ...
 ---
Иногда шаблон функции или класса может быть не эффективен или вовсе неправелен для определённых типов данных. В таком случае можно его _специаллизировать_ - то есть написать его реализацию для данного типа.
